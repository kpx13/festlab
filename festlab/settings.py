...
DATABASES = {
    'default': {
        ...
        'NAME': 'festlab',   # Or path to database file if using sqlite3.
        'USER': 'festlab',                      # Not used with sqlite3.
        'PASSWORD': 'festlab',                  # Not used with sqlite3.
